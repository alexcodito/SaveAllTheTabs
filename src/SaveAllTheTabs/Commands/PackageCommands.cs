...
namespace SaveAllTheTabs.Commands
{
    ...
    internal class PackageCommands
    {
        ...
        private void SetupCommands(OleMenuCommandService commandService)
        {
            ...
            Package.Environment.SetKeyBindings(command, "Global::Ctrl+Shift+Alt+D,S", "Text Editor::Ctrl+Shift+Alt+D,S");
            ...
            commandService.AddCommand(command);
            Package.Environment.SetKeyBindings(command, "Global::Ctrl+Shift+Alt+D,W", "Text Editor::Ctrl+Shift+Alt+D,W");
            ...
            command.BeforeQueryStatus += CommandOnBeforeQueryStatus;
            commandService.AddCommand(command);
            Package.Environment.SetKeyBindings(command, "Global::Ctrl+Shift+Alt+D,C", "Text Editor::Ctrl+Shift+Alt+D,C");
            ...
            Package.Environment.SetKeyBindings(command,
                                               "Global::Ctrl+Shift+Alt+D,V", "Text Editor::Ctrl+Shift+Alt+D,V",
                                               "Global::Ctrl+Shift+Alt+D,`", "Text Editor::Ctrl+Shift+Alt+D,`");
        }
